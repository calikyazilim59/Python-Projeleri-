...
if(kullanıcı_adı==mail1):
    if(kullanıcı_sifre==mail1_sifre):
        print("Hesabınıza giriş yapıldı..")
        
    elif(kullanıcı_sifre != mail1_sifre):
        print("Hesabınızın şifresi yanlış girilmiştir, lütfen kontrol ediniz.")
        
elif(kullanıcı_adı==mail2):
    if(kullanıcı_sifre==mail2_sifre):
        print("Hesabınıza giriş yapıldı")
    
    elif(kullanıcı_sifre != mail2_sifre):
        print("Hesabınızın şifresi yanlış girilmiştir, lütfen kontrol ediniz.")
        
elif(kullanıcı_adı != mail2):
    print("Hesabınızın kullanıcı adını yanlış girdiniz. Lütfen kontrol edip tekrar deneyiniz.")

elif(kullanıcı_adı != mail1):
    print("Hesabınızın kullanıcı adını yanlış girdiniz. Lütfen kontrol edip tekrar deneyiniz.")
